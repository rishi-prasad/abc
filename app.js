...
mongoose.connect('mongodb+srv://user:rishiprasad1010@gmail.com@cluster0.749kx.mongodb.net/allFarmers?retryWrites=true&w=majority', {
...
app.post('/registration', (req, res) => {
    ...
    upload(req, res, err => {
        if (err) {
            ...
            global.receiverFile = `output_${Date.now()}.pdf`;
